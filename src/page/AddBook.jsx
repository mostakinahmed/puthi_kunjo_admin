      ...
      <div className="max-w-7xl mx-auto bg-white  shadow-lg overflow-hidden">
        ...
        <div className="bg-slate-900 text-white px-8 py-6">
          ...
          <p className="text-gray-400 mt-2">
            Fill all book information carefully
          </p>
        </div>
        ...
        >
          ...
          <div className="md:col-span-2 flex justify-end">
            <button
              type="submit"
              className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-xl font-bold flex items-center gap-2 shadow-md transition-all active:scale-95"
            >
              <Upload size={18} />
              Add Book
            </button>
